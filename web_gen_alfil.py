...
def read_student_data(filename):
    ...
    with open(filename, encoding="utf8", newline='') as csvfile:
        ...
        for row in reader:
            ...
            datos_participante['DNI'] = row['Documento']
            datos_participante['Alumno'] = row['Nombre']
...
# Leer datos
participantes = read_student_data("alumnos_alfil.csv")
